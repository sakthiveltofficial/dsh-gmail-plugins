 ...
 *
 * A self-contained Cordis plugin inspired by the Composio Gmail app: 61
 * model-facing tools over the Gmail and People REST APIs, plus two polling
 * triggers (`gmail/message-received`, `gmail/message-sent`) that emit Cordis
 * events while the plugin is mounted.
 *
